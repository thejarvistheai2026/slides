          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-20 -mt-5">
            ...
            <div className="flex-1 max-w-xl">
              <motion.p
                ...
                className="text-white/40 font-body font-light text-sm md:text-base leading-relaxed mb-8"
              >
                ...
                {skills.map((s, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-start gap-2.5">
                      <Icon className={`w-3.5 h-3.5 flex-shrink-0 mt-0.5 ${s.color}`} />
                      <div>
                        <p className={`text-[11px] font-body font-semibold ${s.color}`}>{s.label}</p>
                        <p className="text-[11px] font-body font-light text-white/35 leading-relaxed">{s.desc}</p>
                      </div>
                    </div>
                  );
                })}
            ...
            <motion.div
              ...
              className="w-full lg:w-[400px] flex-shrink-0 flex flex-col items-center gap-6 lg:ml-20"
            >
              ...
              <div className="w-full flex flex-col">
                <div className="liquid-glass rounded-2xl p-4 lg:p-5 flex flex-col gap-3 border border-indigo-500/20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-body font-semibold text-white leading-tight">The Lab</p>
                      <p className="text-[11px] font-body text-indigo-400/70">Discord server</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {["general", "content", "seo"].map((ch) => (
                    <div key={ch} className="liquid-glass rounded-xl py-2 px-2 flex items-center justify-center gap-1">
                      ...
                      <span className="text-[10px] font-body font-medium text-white/35 truncate">{ch}</span>
                    </div>
                  ))}
                </div>
              </div>
